...
import com.kartik.popularmoviesstage2.retrofit.MovieService;
import com.kartik.popularmoviesstage2.ui.recycler_view.MovieRecyclerViewAdapter;
import com.kartik.popularmoviesstage2.utils.MovieNetworkUtils;
import com.kartik.popularmoviesstage2.utils.SharedPreferencesUtils;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadMovies(final int requestType, String endPoint, final boolean reloadAdapterCollection) {
        Call<MovieResults> wrapperCall = mMovieService.getMovies(endPoint, getString(R.string.api_key), mCurrentPageNum);
        wrapperCall.enqueue(new Callback<MovieResults>() {
